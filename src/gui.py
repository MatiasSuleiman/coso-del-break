from PyQt6.QtWidgets import QMainWindow, QLabel, QVBoxLayout, QPushButton, QTextBrowser, QDialog, QLineEdit, QFileDialog
...
class Gui:
    ...
    def buscar(self):
        ...
        self.sistema.establecer_condiciones(self.mostrador_de_condiciones.obtener_condiciones())
